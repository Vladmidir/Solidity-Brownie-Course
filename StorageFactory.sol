...
contract StorageFactory is SimpleStorage {
    ...
    function createSimpleStorageContract() public {
        ...
        //QUESTION: Does this acctually append a block to the blockchain?
        //QUESTION: If it does append a block to the blockchain, is it a permanent change?
        //QUESTION: Where excatly is this being stored? Every node of the blockchain?
    ...
    function sfGet(uint256 _simpleStorageIndex) public view returns(uint256) {
        //dont really need to save it, but still do for clean code.
        SimpleStorage simpleStorage = SimpleStorage(address(simpleStorageArray[_simpleStorageIndex]));
